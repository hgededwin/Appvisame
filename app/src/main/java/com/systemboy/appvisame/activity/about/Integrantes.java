...
/**
 * Created by Generico on 15/04/2015.
 */
public class Integrantes {

    public static final Integrantes[] CONTACTS = new Integrantes[] {
            new Integrantes("Cesar García", "#33b5e5", "+01 123456789", "john@example.com", "Venice"),
            new Integrantes("Daniel Carreto", "#ffbb33", "+01 987654321", "valter@example.com", "Bologna"),
            new Integrantes("Edwin Hernández", "#ff4444", "+01 123456789", "hgededwindaniel@gmail.com", "Verona"),
            new Integrantes("Llulian Soriano", "#99cc00", "+01 987654321", "teddy@example.com", "Rome"),
            new Integrantes("Diana García", "#33b5e5", "+01 11235813", "ives@example.com", "Milan"),
            new Integrantes("Cesar Santiago", "#ffbb33", "+01 123456789", "alajos@example.com", "Bologna"),
            new Integrantes("Nadia", "#ff4444", "+01 11235813", "me@gian.lu", "Padova"),
            new Integrantes("Luis", "#99cc00", "+01 987654321", "fane@example.com", "Venice"),
    };
